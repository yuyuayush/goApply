                    ...
                    <main className="flex-1 overflow-y-auto p-6">
                        <div className="space-y-6">
                            ...
                            >
                                ...
                                <p className="text-muted-foreground mt-1">Discover programs that match your interests
                                    and goals</p>
                            </motion.div>
                            ...
                            >
                                <Card
                                    className="bg-card/50 backdrop-blur border-border/50 hover:bg-card/60 transition-all duration-200">
                                    <CardHeader>
                                        ...
                                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                                            ...
                                            <div className="space-y-2">
                                                ...
                                                <Select value={selectedState} onValueChange={setSelectedState}>
                                                    ...
                                                    <SelectContent>
                                                        ...
                                                        <SelectItem value="western-australia">Western
                                                            Australia</SelectItem>
                                                        <SelectItem value="south-australia">South Australia</SelectItem>
                                                        <SelectItem value="tasmania">Tasmania</SelectItem>
                                                        <SelectItem value="act">ACT</SelectItem>
                                                        <SelectItem value="northern-territory">Northern
                                                            Territory</SelectItem>
                                                    </SelectContent>
                                                </Select>
                                            </div>
                                            ...
                                            <div className="space-y-2">
                                                ...
                                                <Select value={selectedField} onValueChange={setSelectedField}>
                                                    ...
                                                    <SelectContent>
                                                        <SelectItem value="computer-science">Computer
                                                            Science</SelectItem>
                                                    ...
                                                    <div className="space-y-6">
                                                        ...
                                                        <div className="space-y-3">
                                                            ...
                                                            <div
                                                                ...
                                                                <span>3.0</span>
                                                                <span
                                                                    className="font-medium">{minRating.toFixed(1)} ⭐</span>
                                                                <span>5.0</span>
                                                            </div>
                                                        </div>
                            ...
                            >
                                <div className="flex items-center justify-between">
                                    ...
                                    <p className="text-sm text-muted-foreground">{filteredPrograms.length} programs
                                        found</p>
                                </div>
                                ...
                                <div className="grid gap-6">
                                    {filteredPrograms.map((program, index) => (
                                        ...
                                        >
                                            <Card
                                                className="bg-card/50 backdrop-blur border-border/50 hover:shadow-lg hover:-translate-y-1 transition-all duration-300 hover:border-primary/20">
                                                            ...
                                                            <div className="flex items-start justify-between">
                                                                ...
                                                                <div className="text-right space-y-1">
                                                                    ...
                                                                    <div className="flex items-center gap-1">
                                                                        ...
                                                                        <span
                                                                            className="text-sm font-medium">{program.rating}</span>
                                                                    </div>
                                                                </div>
                                                            </div>
                                      ...
                                      {req}
                                                            ...
                                                            <div className="flex items-center justify-between pt-2">
                                                                <p className="text-sm text-muted-foreground">
                                                                    ...
                                                                    className="font-medium text-foreground">{program.deadline}</span>
                                                                </p>
                                                                <div className="flex gap-2">
